...
const VERIFICATION_FILE = path.join(__dirname, '../data/archive/csv/modified/정법생윤경제-verification.csv');
const OUTPUT_FILE = path.join(__dirname, '../data/archive/csv/modified/검증상태보고서.csv');
