...
const REFINED_FILE = path.join(__dirname, '../data/archive/csv/modified/정법생윤경제-refined.csv');
const DB_FILE = path.join(__dirname, '../data/archive/csv/raw/문제데이터_2025-10-03.csv');
const OUTPUT_FILE = path.join(__dirname, '../data/archive/csv/modified/정법생윤경제-verification.csv');
