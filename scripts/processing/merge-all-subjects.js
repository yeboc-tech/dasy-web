...
const FILES_TO_MERGE = [
  {
    name: '정법',
    path: path.join(__dirname, '../data/archive/csv/modified/정법.csv')
  },
  {
    name: '생윤',
    path: path.join(__dirname, '../data/archive/csv/modified/생윤.csv')
  },
  {
    name: '경제',
    path: path.join(__dirname, '../data/archive/csv/raw/경제.csv')
  }
];

const OUTPUT_FILE = path.join(__dirname, '../data/archive/csv/modified/문제데이터_통합.csv');
